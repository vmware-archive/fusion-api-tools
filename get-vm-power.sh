...
# using simple cURL and bash scripting to get the Power State of
# a single VM
# 
...
curl "http://${FUSION_HOST}/api/vms/${VM_ID}/power" -X GET --header "Accept: application/vnd.vmware.vmw.rest-v1+json" --header "Authorization: Basic ${AUTH_STRING}" | json | pygmentize -l json